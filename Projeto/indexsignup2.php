...
<div class="container" style="background-color: #190934;">
    <div class="loginBox"> <img src="imagens/logo/logorosa.png" width="40%" style="margin-left: 30%;">
        ...
        <form action="register2.php" method="post">
            <div class="inputBox">
                <input type="text" id="new_username" placeholder="New Username" name="new_username" required><br><br>
                <input type="password" id="new_password" placeholder="New Password" name="new_password" required><br><br>
            </div>
            <input type="submit" name="" value="Register" style="background-color: #d654a4">
        </form>
    </div>
</div>
